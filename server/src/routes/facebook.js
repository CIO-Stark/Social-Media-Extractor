...
module.exports = (props) => {
    //load all users
    props.server.get('/facebook/load', (req, res) => {
    ...
    props.server.post('/facebook/create', (req, res) => {
        let data = props.parsers.facebook.validateCreate(req.body);
    ...
    props.server.put('/facebook/update', (req, res) => {
        let data = props.parsers.facebook.validateUpdate(req.body);
    ...
    props.server.delete('/facebook/remove', (req, res) => {
        let data = props.parsers.facebook._id_rev(req.body);
    ...
    props.server.get('/facebook/data/:entity', (req, res) => {
    ...
    props.server.post('/facebook/start', (req, res) => {
        let data = props.parsers.facebook._id(req.body);

        if (data) {
            let parsedData = props.parsers.facebook.startParse(data);
    ...
    props.server.delete('/facebook/stop', (req, res) => {
        let data = props.parsers.facebook._id(req.body);
        if (data) {
